          ...
          <div class="company-slider_companySlider__o5_2m max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl relative mx-auto">
            <div class="jsx-4097728753 slider-container">
              <div class="jsx-4097728753 slider-content-wrapper">
                <div class="jsx-4097728753 max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl">
                  <div class="company-slider_companyLogosContainer__nLjp7 flex gap-5 items-center  ">
                    ...
                    <div>
                      <svg height="31px" version="1.1" viewBox="0 0 113 31" width="113px" xmlnsXlink="http://www.w3.org/1999/xlink">
                        <g fill="#000" fill-rule="evenodd" stroke="none" strokeWidth="1" transform="translate(-1274.000000, -1343.000000) translate(-17.000000, 1337.000000) translate(1291.598806, 6.000000)">
