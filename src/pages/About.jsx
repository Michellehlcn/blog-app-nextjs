...
const About = () => {
  ...
  return (
    <div id='about' >
      ...
      <div id="bio" className="mt-[44px] md:mt-[60px] max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl relative mx-auto p-4 mb-10 text-neutral-200;" >
        <div className="px-2 m-auto gap-8 max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl p-5 grid">
        <h1 className="text-[#38bdf8] tracking-wide mb-5">About</h1>
        <p className="uppercase text-xl tracking-wide text-[#5651e5] mb-5 col-span-12">Biography Section</p>
