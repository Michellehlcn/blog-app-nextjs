...
const About = () => {
    return (
        <div id='about' className="w-full p-2 flex items-center ">
            <div className="px-2 m-auto gap-8 max-w-4xl exl:max-w-5xl 3xl:max-w-7xl p-5 border-t-2 border-gray-200 dark:border-gray-400/10 ">
            <p className="uppercase text-xl tracking-wide text-[#5651e5] mb-5">Biography</p>
                ...
                <div className="shadow-xl mb-5 shadow-gray-400 rounded-xl p-3">
                <p className="py-2 ">
