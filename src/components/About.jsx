...
const About = () => {
    return (
        <div id='about' className="w-full p-2 flex items-center">
            <div className="px-2 m-auto gap-8 max-w-4xl exl:max-w-5xl 3xl:max-w-7xl">
           
                    <p className="uppercase text-xl tracking-wide text-[#5651e5]">About</p>
                    <h2 className="py-2">Who I am</h2>
                    <p className="py-2 ">// I am not your normal Developer.</p>
                    <p className="py-2 ">
                    ...
                    <div className="py-2 w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 case-in duration-300">
