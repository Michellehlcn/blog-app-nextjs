                    ...
                    <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4">
                        <div className="lg:p-4 h-full justify-self-center">
                            ...
                            <div>
                                ...
                                <p>Full-stack Sofware Developer/ Freelancer</p>
                                <p className="py-4">I'm am available for freelance or full-time positions. Contact me and let's talk.</p>
                            </div>

                            <p className="uppercase pt-8">Connect With Me</p>
                            <div className="flex justify-center py-4 items-center ">
                                <div className="ml-10 rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in duration-300">
                                    <FaLinkedinIn />
                                </div>
                                <div className="ml-10 rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in duration-300">
                                    <FaGithub />
