...
draft: false
summary: 'Yup. Another bot 🤖 was made. This time it was for my mom’s Facebook page crochet shop. In this post, I will cover the basic messenger automation, GraphQL and how to deploy to one of free tier hosts such as Glitch, Vercel or AWS ...'
---

# Facebook Messenger Bot by Michellehlcn
...
_Source_: [marclittlemore.com](https://www.marclittlemore.com/serverless-telegram-chatbot-vercel/)
